...
def train(gpu, args):
    ...
    for iter_epoch in range(args.n_epoch):
        ...
        elif (iter_epoch + 1) > 40 and (iter_epoch + 1) % 20 == 0 and eval_loss < min_eval_loss:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data_root", required=False, type=str, default=\
    "../../dataset/v2x-seq-tfd/V2X-Seq-TFD-Example/cooperative-vehicle-infrastructure/fusion_for_prediction/interm_data",
    ...
    parser.add_argument("-r", "--local_rank", default=6, type=int,
