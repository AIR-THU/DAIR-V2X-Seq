...
class DAIRV2XDataLoader:
    ...
    def city(self) -> str:
        ...
        Returns:
            city name, i.e., either 'PEK'
        """
        _city: str = self.seq_df["city"].values[0]
        return _city
    ...
    def agent_traj(self) -> np.ndarray:
        ...
        """
        agent_x = self.seq_df[self.seq_df["tag"] == "AGENT"]["x"]
        agent_y = self.seq_df[self.seq_df["tag"] == "AGENT"]["y"]
        agent_traj = np.column_stack((agent_x, agent_y))
        return agent_traj

    def __iter__(self) -> "DAIRV2XDataLoader":
    ...
    def __next__(self) -> "DAIRV2XDataLoader":
    ...
    def __getitem__(self, key: int) -> "DAIRV2XDataLoader":
    ...
    def get(self, seq_id: Union[Path, str]) -> "DAIRV2XDataLoader":
